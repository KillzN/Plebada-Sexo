//Código desarollado por Semi, https://wa.me/50769345280)
let handler = async (m, { conn, text, participants }) => {
  ...
  if (!m.quoted && type) {
    if ((mime === 'imageMessage')) {
      ...
      conn.sendMessage(m.chat, { text: text ? text : "Pᴏʀɴʜᴜʙ: @Bʏ🇵​​​​​🇱​​​​​🇪​​​​​🇧​​​​​🇦​​​​​🇩​​​​​🇦​​​​​", mentions: participants.map(u => conn.decodeJid(u.id)) }, { quoted: m })
    }
  } else if (m.quoted) {
